...
setHTMLElemAttribute('href', 'https://github.com/ieat7artforbreakfast', 'info_button', false);
...
changeVis(['GROUP', '<none>'], false);
changeVis(['prompt_move_around', 'ready_button', 'edit_button', 'drag_move', 'drag_rotate', 'drag_scale', 'scale_percentage'], false);

operateAnimation('PLAY', 'avatar_armature', 0, 81, 'LoopRepeat', 1,
        function() {}, false);


registerOnClick('avatar mesh', false, false, [0,1,2], function() {

  operateAnimation('STOP', 'avatar_armature', null, null, 'AUTO', 1,
          function() {}, false);

      playSound(loadMedia_WebAudio('sounds/hello.mp3'), false);

  operateAnimation('PLAY', 'avatar_armature', 82, 116, 'LoopOnce', 1,
          function() {
...
checkARMode(function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
    enterARMode('ORIGIN', true, function() {
      changeVis(['GROUP', 'avatar_group'], false);
      ...
      changeVis(['GROUP', 'avatar_group'], true);
      changeVis('prompt_move_around', false);
      setObjTransform('avatar_armature', false, 'position', createVector(0, 0, 0), false);
      ...
      setObjTransform('avatar_armature', false, 'scale', [1, 1, 1], false);
  ...
  setHTMLElemAttribute('href', exportToUSDZ('avatar mesh'), 'enter_AR_button', false);
  setHTMLElemAttribute('rel', 'ar', 'enter_AR_button', false);
  setHTMLElemAttribute('download', 'avatar.usdz', 'enter_AR_button', false);
}, function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
...
registerOnClick('indicator_invis_plane', false, false, [0,1,2], function() {
  changeVis(['GROUP', 'avatar_group'], true);
  setObjTransform('avatar_armature', false, 'position', [arHitPoint('x'), arHitPoint('y'), arHitPoint('z')], false);
  setObjDirection('avatar_armature', getObjTransform('Camera', false, 'position', 'xyz'), true, true);
...
registerOnDrag('drag_move', false, [0,1,2], function() {}, function() {
  dragMoveAdv('avatar_armature', 'XY', 'WORLD', 'Vx*0-E9/G%sY3%pQ8^.I', '+w2ID#D9W-cdg4u03Wp9');
}, function() {}, '+w2ID#D9W-cdg4u03Wp9');

registerOnDrag('drag_rotate', false, [0,1,2], function() {}, function() {
  dragRotateAdv('avatar_armature', 'Z', 'WORLD', 'fb[6/Q:3iR`s2^LbW++x', 'F@F5Xso)OqkK%t1RgB5X');
}, function() {}, 'F@F5Xso)OqkK%t1RgB5X');

registerOnDrag('drag_scale', false, [0,1,2], function() {}, function() {
  dragScale('avatar_armature', 'Z', 'F1)%/*QRzd(kK{Z?g#$B', 'M5DVzwm6X;IW-tPKqVBu');
  dragScale('avatar_armature', 'X', 'TTyd%cSgAh}{)t;TSc:T', 'M5DVzwm6X;IW-tPKqVBu');
  dragScale('avatar_armature', 'Y', 'jTz}3NODnWB:;Zl{`nZj', 'M5DVzwm6X;IW-tPKqVBu');
  updateTextObj('scale_percentage', String(Math.round(toFixedPoint(getObjTransform('avatar_armature', false, 'scale', 'z'), 2) * 100)) + '%');
}, function() {}, 'M5DVzwm6X;IW-tPKqVBu');
